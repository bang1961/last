...
MK3   = False
ROOT_PATH = '/home/super/projects/thyroid/datasets' if ok else '/home/super/바탕화면/share/lt4/'

today = datetime.date.today()
year = today.year
month = str(today.month).zfill(2)
day = str(today.day).zfill(2)
os.makedirs(f'{ROOT_PATH}/log', exist_ok = True)
...
def log_writer(message, level = 'err'):
    ...
    logging.basicConfig(filename=f'{ROOT_PATH}/log/log-{year}{month}{day}.log',
