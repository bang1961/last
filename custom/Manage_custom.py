...
DATASET_PATH = f'{ROOT_PATH}/bang/Datasets'
SAVE_PATH = f'{ROOT_PATH}/bang/classification/histogram/model_Image'
...
def file_rename(grade = 'C3'):
    ...
    remove_key = list(excel_file.columns)[-5]
...
def C2():
    ...
    file_names_C2 =os.listdir(f"{DATASET_PATH}/train/C2")
