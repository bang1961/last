...
def Sagittal_class(path):
    for p in os.listdir(path):
        ...
        for sagittal in image_paths:
            ...
            os.makedirs(f'/home/super/projects/thyroid/datasets/횡단만/22.04.22/{label_name}', exist_ok = True)
            
            if sagittal.split('__')[1] == '1_.jpg' or sagittal.split('__')[1] =='2_.jpg':
                print(f'{x}/{file_name} =>>/home/super/projects/thyroid/datasets/횡단만/22.04.22/{label_name}/{file_name}')
